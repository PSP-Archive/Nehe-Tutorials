...
// Used keys :
// START = exit 
// circle = Toggle From One Scene To The Other
// cross = Toggle Masking Mode OFF/ON
...
//int fullscreen=0;	// toggle fullscreen @@@ PSP is allways fullscreen
int x_position = 50;	/* position on screen */
int y_position = 50;
int width = 480;	// @@@ Size of PSP screen
int height = 272;
...
void LoadGLTextures() /* Load Bitmaps And Convert To Textures */
{
	...
	ImageLoad("Data/logo.bmp", TextureImage[0]);
	ImageLoad("Data/mask1.bmp", TextureImage[1]);
	ImageLoad("Data/image1.bmp", TextureImage[2]);
	ImageLoad("Data/mask2.bmp", TextureImage[3]);
	ImageLoad("Data/image2.bmp", TextureImage[4]);
...
//		glutDestroyWindow(window);  @@@ don't exist in pspgl
    ...
    case 'o': // circle : Toggle From One Scene To The Other
		scene = !scene;
	break;

    case 'x': // cross : Toggle Masking Mode OFF/ON
		masking = !masking;
	break;
...
//    glutSpecialFunc(specialKeyPressed); @@@ was needed for fullscreen

    /* Use this to save CPU when the scene is obscured/iconised */
//    glutVisibilityFunc(Icon); @@@ unusefull
